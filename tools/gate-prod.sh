...
run node tools/verify-render-atomic-swap.mjs
run node tools/verify-core-swap-no-innerhtml.mjs
run node tools/verify-core-domparser-singleton.mjs
run node tools/verify-api-fetch-contract.mjs
run node tools/verify-api-fetch-catch-contract.mjs
...
run node tools/verify-shortcodes-a11y-contract.mjs
...
run node tools/verify-perf-workflow-contract.mjs
run node tools/verify-perf-history-contract.mjs
run node tools/verify-perf-urls-ssot.mjs
