...
const commandChecks = [
  ...
  ["unified data contract", "npm", ["run", "gaga:verify-unified-data-contract"]],
  ["controller core adapters", "npm", ["run", "gaga:verify-controller-core-adapters"]],
  ...
  ["CSS visual rhythm source", "npm", ["run", "gaga:verify-css-source-visual-rhythm"]],
  ["lazy interaction budget", "npm", ["run", "gaga:verify-lazy-interaction-budget"]],
  ["comments proof", "npm", ["run", "gaga:verify-comments-proof"]],
  ["global sheet contract", "npm", ["run", "gaga:verify-global-sheet-contract"]],
  ["sheet gesture close", "npm", ["run", "gaga:verify-sheet-gesture-close"]],
  ...
  ["root UX polish", "npm", ["run", "gaga:verify-root-ux-polish"]],
...
const sizeBudgets = [
  ...
  ["src/js/gg-app.source.js", 480 * 1024, 400 * 1024, "Blogger app JS source"],
