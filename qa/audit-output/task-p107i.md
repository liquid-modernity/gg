...
- Size: 2073132 bytes (1.98 MB)
- Top-level roots: `.github`, `.gitignore`, `.vscode`, `docs`, `index.dev.xml`, `index.prod.xml`, `lighthouse`, `package-lock.json`, `package.json`, `public`, `qa`, `src`, `wrangler.jsonc`
- File count: 164
- Junk entries: _none_
...
## D. Workflow Summary
- workflow files: 2
- `.github/workflows/ci.yml` | ci:yes deploy:yes wrangler:yes npm-run-gaga:yes run-blocks:6
- `.github/workflows/deploy.yml` | ci:no deploy:yes wrangler:yes npm-run-gaga:yes run-blocks:10
...
- qa/live-smoke targets tes-2 comments page: yes
...
Report generated at: 2026-03-15T21:33:07.194Z
