...
requirePattern(indexXml, /<header\b(?=[^>]*class=['"]gg-listing-toolbar['"])(?=[^>]*data-gg-module=['"]listing-toolbar['"])[^>]*>/is, "root listing has stable listing toolbar contract", "index.xml");
requirePattern(indexXml, /<a\b(?=[^>]*class=['"]gg-root-profile__card['"])(?=[^>]*href=['"]\/p\/about\.html['"])[^>]*>[\s\S]*class=['"]gg-root-profile__avatar['"]/is, "listing toolbar includes correctly named root profile avatar", "index.xml");
requirePattern(indexXml, /<button\b(?=[^>]*class=['"]gg-listing-toolbar__filter['"])(?=[^>]*data-gg-listing-filter-trigger=['"]true['"])(?=[^>]*aria-haspopup=['"]menu['"])(?=[^>]*aria-expanded=['"]false['"])[^>]*>/is, "listing toolbar filter trigger is accessible", "index.xml");
...
requirePattern(indexXml, /<nav\b(?=[^>]*class=['"][^'"]*\bgg-detail-outline\b[^'"]*\bgg-listing-pagination\b[^'"]*['"])(?=[^>]*data-gg-module=['"]outline-peek['"])(?=[^>]*data-gg-outline-mode=['"]pagination['"])[^>]*>/is, "root listing pagination uses outline-peek pagination mode", "index.xml");
