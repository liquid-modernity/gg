...
check_pattern 'queryFlag\(["'"'"']debugOverflow["'"'"']\)' "artifact debugOverflow gate is missing"
check_pattern 'queryFlag\(["'"'"']debugVitals["'"'"']\)' "artifact debugVitals gate is missing"
...
check_pattern 'id=["'"'"']store-semantic-empty-template["'"'"']' "artifact semantic empty template is missing"
check_pattern 'id=["'"'"']store-semantic-tag-template["'"'"']' "artifact semantic tag template is missing"
...
check_pattern '@supports not \(overflow-x: clip\)' "artifact overflow-x hidden fallback guard is missing"
...
check_absent 'fetchpriority=["'"'"']low["'"'"']' "artifact should not ship low fetchpriority on store card images"
...
check_absent 'document\.createElement\(["'"'"']p["'"'"']\)' "artifact semantic empty UI must use template cloning, not document.createElement(\"p\")"
check_absent 'document\.createElement\(["'"'"']span["'"'"']\)' "artifact semantic tag UI must use template cloning, not document.createElement(\"span\")"
