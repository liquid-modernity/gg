...
- `src/modules/offline-fallback-bridge/offline-fallback-bridge.js` owns low-risk network/fallback state helpers and fallback status payload helpers. Search-empty, 404, listing growth, timers, rendering, and fetch orchestration stay in `legacy-app.js`.
