(function () {
  'use strict';
    ...
    var PANEL_SCROLL_POLICY = {
      ...
      discovery: { openBeforeRender: true, openAfterRender: true, closeAfterHide: true, queryChange: true, filterChange: true },
      saved: { openBeforeRender: true, openAfterRender: true, closeAfterHide: true, filterChange: true },
      more: { openBeforeRender: true, openAfterRender: true, closeAfterHide: true, clearLocalSearchOnClose: true, closePreferencePanelOnClose: true }
    };
    var DEBUG_FLAGS = {
    ...
    function collectPanelScrollTargets(root) {
      ...
      if (root.querySelectorAll) {
        targets = targets.concat([].slice.call(root.querySelectorAll('[data-gg-scroll-container], .gg-sheet__panel, .gg-content-sheet__panel')));
      }
      return targets.filter(function (node, index) { return !!node && targets.indexOf(node) === index; });
    }
