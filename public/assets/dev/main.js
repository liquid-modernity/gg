...
(function(GG, w, d){
  ...
  services.manifest.init = services.manifest.init || function(opts){
    var options = opts || {};
    var href = options.href || '/manifest.webmanifest';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (dock && GG.modules.ReadingProgress) {
    GG.modules.ReadingProgress.init(dock, main);
  }
  if (dock && GG.modules.DockPerimeter) {
    GG.modules.DockPerimeter.init(dock);
  }
  if (GG.modules.BackToTop) {
    GG.modules.BackToTop.init();
  }
  if (GG.modules.LoadMore) {
    GG.modules.LoadMore.init();
  }
  if (hasHomeRoot) {
    setTimeout(function(){
  ...
  if (GG.modules.PopularCarousel) {
    GG.modules.PopularCarousel.init();
  }
  if (GG.modules.RelatedInline) {
    GG.modules.RelatedInline.init();
  }
});
