...
(function(GG){
  ...
  GG.modules.ui.init = GG.modules.ui.init || function(){
    ...
    else if (GG.app && typeof GG.app.init === 'function') GG.app.init();

    if (GG.boot && GG.boot._init) {
      if (GG.services && GG.services.actions && GG.services.actions.init) GG.services.actions.init();
      var runNow = function(){
        if (GG.core && GG.core.router && GG.core.router.init) GG.core.router.init();
        if (GG.services && GG.services.a11y && GG.services.a11y.init) GG.services.a11y.init();
      };
      if (GG.boot && GG.boot.defer) GG.boot.defer(runNow);
      else setTimeout(runNow, 1);
    }
  };
})(window.GG = window.GG || {});
