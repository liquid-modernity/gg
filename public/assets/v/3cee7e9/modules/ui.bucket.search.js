...
var DOCK_SEL = 'nav.gg-dock[data-gg-module="dock"]';
function dockVisible(el){
if (!el || el.hasAttribute('hidden')) return false;
var r = el.getBoundingClientRect();
return !!(r && r.width > 0 && r.height > 0);
}
function applyAnchor(host){
var dock = d.querySelector(DOCK_SEL);
if (!dockVisible(dock)) {
host.setAttribute('data-mode', 'center');
return false;
}
var r = dock.getBoundingClientRect();
host.style.setProperty('--gg-anchor-x', r.left + 'px');
host.style.setProperty('--gg-anchor-y', r.top + 'px');
host.style.setProperty('--gg-anchor-w', r.width + 'px');
host.style.setProperty('--gg-anchor-h', r.height + 'px');
host.setAttribute('data-mode', 'dock');
return true;
}
...
w.visualViewport.addEventListener('resize', onResize);
}
}
...
if (state._t) {
try { state._t(); } catch (e) {}
state._t = null;
}
if (GG.services && GG.services.a11y && GG.services.a11y.focusTrap) {
state._t = GG.services.a11y.focusTrap(ui.root, { autofocus: false });
}
...
if (state._i && GG.services && GG.services.a11y && GG.services.a11y.inertManager) {
