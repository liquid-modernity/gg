...
var n=toks(query),q=n.q,tk=n.t,out=[],i,k,it,t,s,l,u,tw,lw,sc,base,z,r,ft=tk[0]||q;
...
if((q&&t.indexOf(q)===0)||(ft&&t.indexOf(ft)===0))base+=100;
...
M.searchRank={run:run,toks:toks,h:h};
})(window);
