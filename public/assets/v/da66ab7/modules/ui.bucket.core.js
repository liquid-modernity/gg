...
function setHref(sel, val, src){ var el = qs(sel, panel); if (!el) return; el.setAttribute('href', val || '#'); if(src) el.setAttribute('data-src', src); else el.removeAttribute('data-src'); }
