...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tokens-settings-root | tokens/settings-root | tokens/settings | global CSS settings | global | `:root{`<br>`--gg-bg:`<br>`--z-dock:` | start: `:root{`<br>end: `@supports (color: color-mix(in srgb, black 50%, white)){` | stable_official | Global token/root settings for color, spacing, layout columns, z-index, and dock variables. This is mapped as settings, not a component family. |
| base-reset-focus | base/reset-focus | base | global CSS base | global | `*::after{ box-sizing: border-box; }`<br>`html, body{`<br>`:where(a, button, input, textarea, select, summary, [role="button"], [tabindex]):focus-visible{` | start: `*::after{ box-sizing: border-box; }`<br>end: `:where(a, button, input, textarea, select, summary, [role="button"], [tabindex]):focus-visible{` | stable_official | Global reset and keyboard focus-visible rules. Must remain cross-surface and not become a route router. |
| primitive-icon-chip | gg-icon/gg-chip primitives | primitive | shared primitive CSS | global | `.gg-visually-hidden{`<br>`.gg-icon{`<br>`.gg-chip{` | start: `.gg-visually-hidden{`<br>end: `.gg-chip{` | stable_official | Small shared primitive cluster for visually hidden text, icons, icon buttons, and chips. Contains one legacy touch selector for info-panel icon meta. |
| gg-dock | gg-dock | component | global dock component | global, listing, post, page, landing | `nav.gg-dock[data-gg-module="dock"]{`<br>`nav.gg-dock[data-gg-state~="search"]{`<br>`nav.gg-dock .gg-dock__progress{` | start: `nav.gg-dock[data-gg-module="dock"]{`<br>end: `nav.gg-dock .gg-dock__progress{` | stable_official | Global dock family, including search/autohide state and later progress bar rules. Later progress rules are separated in file order but still dock-owned. |
...
| search-assist | gg-search-surface | surface-specific | search/listing assist surface | listing, search | `#gg-search-assist.gg-search-assist{`<br>`a.gg-search-assist__item{`<br>`#gg-search-assist .e{` | start: `#gg-search-assist.gg-search-assist{`<br>end: `#gg-search-assist .f{` | stable_official | Inline search-assist surface. It is separate from the command palette search-result surface mapped later. |
...
| gg-mixed-media | gg-mixed-media | component | listing mixed media rail component | listing, home | `.gg-mixed{`<br>`.gg-mixed__rail{`<br>`.gg-mixed[data-type="newsdeck"]` | start: `.gg-mixed{`<br>end: `.gg-newsdeck{` | stable_official | Mixed-media rails, including bookish/featured/instagram/youtube/shorts/podcast/popular/newsdeck variants. |
| listing-surface-grid | gg-listing-surface | surface-specific | listing surface layout | listing, home, label, search | `main.gg-main[data-gg-surface="listing"]{`<br>`main.gg-main[data-gg-surface="listing"] .gg-blog-main #postcards{`<br>`main.gg-main[data-gg-surface="listing"] .gg-loadmore-wrap{` | start: `main.gg-main[data-gg-surface="listing"]{`<br>end: `main.gg-main[data-gg-surface="listing"] .gg-loadmore-wrap{` | stable_official | Listing surface placement and post-card/mixed-widget flow. Surface-owned context only; it should not own card internals. |
| label-channel | gg-label-channel | surface-specific | label/search channel surface | listing, label, search | `#gg-label-channel{`<br>`#gg-label-channel .gg-label-channel__rail{`<br>`#gg-label-channel .gg-label-channel__error{` | start: `#gg-label-channel{`<br>end: `#gg-label-channel .gg-label-channel__error{` | stable_official | Label channel rail/masonry surface block. |
| gg-editorial-preview | gg-editorial-preview | component | listing editorial preview component | listing, home | `.gg-editorial-preview{`<br>`.gg-editorial-preview .gg-info-panel__toclist{`<br>`.gg-editorial-preview .gg-info-panel__tochint{` | start: `.gg-editorial-preview{`<br>end: `.gg-editorial-preview .gg-info-panel__tochint{` | stable_official | Official listing-owned family. Do not classify as legacy; remaining .gg-info-panel descendant selectors are bridge debt tracked in the migration ledger. |
| gg-info-panel-legacy | gg-info-panel | legacy bridge debt | bridge-only right-panel legacy family | listing, home, post, page | `.gg-blog-sidebar--right > .gg-info-panel`<br>`.gg-info-panel__fallback{`<br>`main.gg-main:is([data-gg-surface="post"],[data-gg-surface="page"]) .gg-blog-layout--post :is(.gg-detail-info-sheet,.gg-info-panel){` | start: `.gg-blog-sidebar--right > .gg-info-panel`<br>end: `main.gg-main:is([data-gg-surface="post"],[data-gg-surface="page"]) .gg-blog-layout--post :is(.gg-detail-info-sheet,.gg-info-panel){` | legacy_bridge | Bridge-only legacy family. Listing wrapper usage must resolve to gg-editorial-preview; detail/right-panel metadata usage now resolves through the official gg-detail-info-sheet family. |
...
| gg-detail-info-sheet | gg-detail-info-sheet | component | post/page detail metadata official runtime family | post, page | `.gg-detail-info-sheet__card,`<br>`main.gg-main:is([data-gg-surface="post"],[data-gg-surface="page"]) .gg-blog-layout--post :is(.gg-detail-info-sheet,.gg-info-panel){`<br>`:is(.gg-detail-info-sheet__card,#gg-postinfo) .gg-pi__hint{` | start: `.gg-detail-info-sheet__card,`<br>end: `:is(.gg-detail-info-sheet__card,#gg-postinfo) .gg-pi__hint{` | stable_official | Official runtime family for post/page detail metadata. It is currently dual-supported with #gg-postinfo and .gg-info-panel bridge selectors for migration parity; gg-editorial-preview remains listing-owned only. |
| detail-info-sheet-legacy | gg-postinfo | legacy bridge debt | post/page detail metadata bridge | post, page | `#gg-postinfo,`<br>`:is(.gg-detail-info-sheet__card,#gg-postinfo) .gg-pi__body{`<br>`:is(.gg-detail-info-sheet__card,#gg-postinfo) .gg-pi__hint{` | start: `#gg-postinfo,`<br>end: `:is(.gg-detail-info-sheet__card,#gg-postinfo) .gg-pi__hint{` | legacy_bridge | Legacy detail metadata bridge from #gg-postinfo and gg-pi selectors toward the official gg-detail-info-sheet family. Do not treat gg-postinfo as final family law. |
...
| landing-shell | gg-landing-shell | surface-specific | landing/home surface shell | landing, home | `#gg-landing{`<br>`.gg-topbar{`<br>`.gg-hero{` | start: `#gg-landing{`<br>end: `.gg-hero__stats{` | stable_official | Landing surface shell, topbar, hero, sections, and CTA structure. |
...
| share-sheet | gg-share-sheet | component | share sheet and poster card component | listing, post, page | `.gg-share-card {`<br>`#gg-share-sheet{`<br>`#gg-share-sheet .gg-share-sheet__hint{` | start: `.gg-share-card {`<br>end: `.gg-share-sheet__hint{` | stable_official | Share-card preview plus share-sheet modal/panel rules, including poster-sheet compatibility selectors. |
| command-search-surface | gg-command-palette | component | command palette search component | global, search | `.gg-dialog {`<br>`#gg-palette-list{`<br>`#gg-palette-list .gg-search__result{` | start: `.gg-dialog {`<br>end: `#gg-palette-list > .gg-search__hint:last-child{` | stable_official | Command palette/search result surface. This covers the overlay search result list, not inline search assist. |
...
| ID | Bridge From | Target Family | Owner Context | Status | Reason | Follow-up Task Class |
| --- | --- | --- | --- | --- | --- | --- |
...
| gg-info-panel-bridge | `.gg-info-panel`<br>`.gg-info-panel__*` | `gg-editorial-preview`<br>`gg-detail-info-sheet` | bridge-only; listing-owned pieces target gg-editorial-preview, detail metadata pieces target gg-detail-info-sheet | legacy_bridge | gg-info-panel is not final family law; detail metadata now has an official gg-detail-info-sheet runtime family while listing-owned pieces remain gg-editorial-preview. | css-naming-migration |
| gg-postinfo-to-detail-info-sheet | `#gg-postinfo`<br>`.gg-pi__*` | `gg-detail-info-sheet` | detail-owned bridge-only metadata area; official runtime family is gg-detail-info-sheet | legacy_bridge | #gg-postinfo remains a legacy host ID bridge after introducing the official gg-detail-info-sheet runtime family. | css-xml-contract-migration |
...
Run `npm run gaga:verify-css-map` after changing this map. The verifier checks that every mapped anchor exists in `public/assets/v/ac33998/main.css`, that `public/assets/latest/main.css` remains byte-identical to the active bridge, that required families are represented by either current family or ledger target, and that high-risk migration ledger entries keep `gg-editorial-preview`, `gg-info-panel`, `gg-postinfo`, and `.gg-post__toolbar` classification honest.
